...
import { TipoHabitacion, Habitacion, Hotel, Ubicacion } from '../../models/hotel.model';
...
export class AsignarHabitacionesDialogComponent {
  ...
  tiposHabitacion = Object.values(TipoHabitacion);
  UbicacionHotel= Object.values(Ubicacion);
  constructor(
